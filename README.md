...
- **Python 3.8+**
- **Microsoft Access Database Engine** (required - see installation guide below)
...
git clone https://github.com/yourusername/mcp-server-access.git
...
```json
{
  "mcpServers": {
    "access-db": {
      "command": "python",
      "args": ["main.py"],
      "cwd": "./path/to/mcp-server-access",
      "env": {
        "PYTHONPATH": "./path/to/mcp-server-access"
      },
      "disabled": false,
      "autoApprove": [
        "create_database",
